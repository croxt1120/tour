define([
	...
	var defaultData = {
		...
		"contract": {
	        ...
	        "insurance": "",
	        "remarks": "",
	        "notice": "* 본 계약조건에 명시되지 않은 사항은 관광공사의 표준여행약관에 규정된 바에 준합니다.\n* 상기내용은 항공기의 사정이나 리조트 프로모션 종료 및 현지의 사정 등으로 인하여 변경될 수 있습니다.\n* 도착일 30일 이내 취소 시 총 호텔 요금의 100% 수수료 발생합니다.\n* 취소시점에 따른 항공 및 리조트 특약 사항에 따른 수수료는 별도 발생 되십니다.\n* 여권상의 영문명과 다를시 이름변경 수수료가 발생되십니다. [여권사본은 담당자에게 꼭 보내주세요]"
	    }
    };
	var TourData = Backbone.View.extend({
	    ...
	    clearData : function(){
	        this.tourData = $.extend({}, defaultData);
		    this.trigger("change:all");
	    }
	});
